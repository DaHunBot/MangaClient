...
/*
 * Unofficial API for MangaHere.com
 * @author David Huynh
 */
public class MangaHereAPI implements MorEngine {

    //Saves Manga Url for future uses.
    private String currentURL;

    //MangaHere API Variables
    private final static String MANGAHERE_URL = "http://www.mangahere.com/manga/";
    ...
    /*
    * Setting the URL to start at from MangaHere
    * Throws if MOR cannot connect to MangaHere.com
     */
    ...
    * Default Page: Horimiya
    ...
    public MangaHereAPI() throws IOException {
        this("http://www.mangahere.co/manga/horimiya/c001/");//Default Manga         
    }
    ...
    * Checks to see if there the page url is still live
    ...
    public String getMangaURL(String mangaName) {
        ...
        try {
            ...
            mangaURL = MANGAHERE_URL + mangaURL;
        }
