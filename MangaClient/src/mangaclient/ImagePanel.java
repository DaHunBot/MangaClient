...
public class ImagePanel extends JLabel
        implements MenuContainer, Serializable, SwingConstants {
    ...
    private void addMouseListeners() {
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                ...
                } else if (isZoomed && SwingUtilities.isLeftMouseButton(me)) {
                    //Begins to zoom
        ...
        this.addMouseWheelListener(new MouseAdapter() {
            //This listener zooms using mouse wheel
            @Override
            public void mouseWheelMoved(MouseWheelEvent me) {
                ...
                y -= dy;
                try {
                    //Makes the origin reset only happen once.
                    Robot bot = new Robot();
        ...
        this.addComponentListener(new ComponentAdapter() {
            //Resizes image when component resizes
            @Override
    ...
    /**
     * Overridden to convert icon into images.
     */
    @Deprecated
    @Override
    ...
    /**
     * Returns null to prevent painting issues. Use get image instead.
     */
    @Deprecated
    @Override
    public Icon getIcon() {
